...
export const Auth = ({type}:{type:'signup'|'signin'})=>{
    ...
    return <div className="h-screen flex justify-center ">
        <div className=" flex justify-center flex-col">
            ...
            <div className="pt-4">
                {type == 'signup'? <LabelledInput label="Name" placeholder="Pradeep kumar" onChange={(e)=>{
                    setPostInputs({
                        ...postInputs,
                        name:e.target.value
                    })
                }}/> : null}
                <LabelledInput label="Username" placeholder="Pradeep@gamil.com" onChange={(e)=>{
                    setPostInputs({
                        ...postInputs,
...
return <div className="pt-3">
         <div>
            <label className="block mb-2 text-bold font-bold text-black">{label}</label>
